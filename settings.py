...
from .private.secret_settings import DB_USER, DB_PASSWORD, DB_NAME, DB_CONNECTION
# db settings
...
DB_POOL_SIZE = 1
DB_MIGRATE = True #This means when you see a declaration of database tables, make sure they exist in the database
